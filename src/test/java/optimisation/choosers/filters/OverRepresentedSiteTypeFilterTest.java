...
public class OverRepresentedSiteTypeFilterTest {

  private Site cultural1, cultural2, natural1, natural2;
  private OverRepresentedSiteTypeFilter filter;
  ...
  @Test
  public void cultural_site_has_interest_returns_false_when_more_natural() {
    solution =
        Solution.builder()
            .start(start)
            ...
            .build(matrix);
    Assertions.assertFalse(filter.siteHasInterest(solution, cultural1));
  }
  ...
  @Test
  public void cultural_site_has_interest_returns_true_when_more_cultural() {
    solution =
        Solution.builder()
            .start(start)
            .visitedSite(cultural1)
  ...
  @Test
  public void natural_site_has_interest_returns_true_when_more_natural() {
    solution =
        Solution.builder().start(start).visitedSite(natural1).unvisitedSite(natural2).build(matrix);
  ...
  @Test
  public void natural_site_has_interest_returns_false_when_more_cultural() {
    solution =
        Solution.builder()
            .start(start)
            .visitedSite(cultural1)
            ...
            .build(matrix);
    Assertions.assertFalse(filter.siteHasInterest(solution, natural1));
  }
}
