...
public class App {
  ...
  public static void main(final String[] args) throws IOException {
    ...
    final var solver = createSolver(instance);
    final var solution = solver.solve();
  ...
  private static Solver createSolver(final Instance instance) {
    final var constraintManager = ConstraintManager.builder()
        .constraint(new MaxTripDurationConstraint(THREE_WEEKS_IN_SECONDS))
        .build();
    final var objectiveManager = ObjectiveManager.builder()
